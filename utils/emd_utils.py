...
if __name__ == '__main__':
    ...
    cosine_distance_matrix = torch.rand(batch_size, num_node1, num_node2).cuda()

    weight1 = torch.rand(batch_size, num_node1).cuda()
    weight2 = torch.rand(batch_size, num_node2).cuda()
